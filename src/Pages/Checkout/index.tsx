...
import { GetFullPrice, parseToBrl } from '../../utils'
...
const Checkout = () => {
  ...
  const totalPrice = GetFullPrice(items)
  ...
  const form = useFormik({
    ...
    validationSchema: Yup.object({
      fullName: Yup.string()
        .min(5, 'O nome precista ter pelo menos 5 caracteres')
              ...
              <S.Row>
                ...
                <S.InputGroup>
                  ...
                  <input
                    ...
                    onBlur={form.handleBlur}
                    className={
                      checkInput('confirmeDeliveryEmail') ? 'error' : ''
                    }
                  />
                </S.InputGroup>
              </S.Row>
